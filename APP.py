...
def crear_pdf():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        fig1.write_image(fig1_path, width=900, height=500, scale=2)
        fig2.write_image(fig2_path, width=900, height=500, scale=2)
        fig3.write_image(fig3_path, width=900, height=500, scale=2)
